...
/**
 *	\file       connecteurapp/connecteurappindex.php
 *	\ingroup    connecteurapp
 *	\brief      Home page of connecteurapp top menu
 */
...
$langs->loadLangs(array("connecteurapp@connecteurapp"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->connecteurapp->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("ConnecteurAppArea"));

print load_fiche_titre($langs->trans("ConnecteurAppArea"), '', 'connecteurapp.png@connecteurapp');
...
// Draft MyObject
if (! empty($conf->connecteurapp->enabled) && $user->rights->connecteurapp->read)
{
	$langs->load("orders");
