...
/**
 * \file    test/functional/ConnecteurAppFunctionalTest.php
...
/**
 * Class ConnecteurAppFunctionalTest
 *
 ...
 *
 * @package Testconnecteurapp
 */
class ConnecteurAppFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modConnecteurApp')->click();
		} else {
			// Disable the module
			$this->byHref('modConnecteurApp')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/connecteurapp/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('connecteurapp/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/connecteurapp/admin/about.php');
		$this->authenticate();
		return $this->assertContains('connecteurapp/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('connecteurappwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modConnecteurApp_ConnecteurAppTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modConnecteurApp_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
