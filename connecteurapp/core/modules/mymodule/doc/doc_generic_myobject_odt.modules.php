...
/**
 *	\file       htdocs/core/modules/connecteurapp/doc/doc_generic_myobject_odt.modules.php
...
class doc_generic_myobject_odt extends ModelePDFMyObject
{
    ...
    public function __construct($db)
	{
		...
		$this->scandir = 'CONNECTEURAPP_MYOBJECT_ADDON_PDF_ODT_PATH'; // Name of constant that is used to save list of directories to scan
    ...
    public function info($langs)
	{
		...
		$texte .= '<input type="hidden" name="param1" value="CONNECTEURAPP_MYOBJECT_ADDON_PDF_ODT_PATH">';
		$texte .= '<table class="nobordernopadding" width="100%">';

		// List of directories area
		$texte .= '<tr><td>';
		$texttitle = $langs->trans("ListOfDirectories");
		$listofdir = explode(',', preg_replace('/[\r\n]+/', ',', trim($conf->global->CONNECTEURAPP_MYOBJECT_ADDON_PDF_ODT_PATH)));
		$listoffiles = array();
		...
		$texte .= $conf->global->CONNECTEURAPP_MYOBJECT_ADDON_PDF_ODT_PATH;
		$texte .= '</textarea>';
		...
		if (!empty($conf->global->CONNECTEURAPP_MYOBJECT_ADDON_PDF_ODT_PATH))
		{
    ...
    public function write_file($object, $outputlangs, $srctemplatepath, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->commande->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				dol_mkdir($conf->connecteurapp->dir_temp);
